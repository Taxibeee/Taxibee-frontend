...
const nlTranslations = {
  ...
  homepage: {
    ...
    heroDesc:
      'Geïnspireerde operaties, live gegevens en krachtige analytics voor taxibedrijven en chauffeurs',
    features: {
      title: 'Krachtige Vlootbeheer',
      feature1: {
        title: 'Live chauffeurtracker',
        content:
          'Bewaar je vloot in real-time. Volg de status van de chauffeurs, beschikbaarheid en huidige bestellingen vanaf elk punt.',
      },
      feature2: {
        title: 'Uitgebreide analyse',
        content:
          'Krijg waardevolle inzichten met gedetailleerde analyses over omzet, chauffeursprestaties en klanttrends.',
      },
      feature3: {
        title: 'Chauffeur Portal',
        content:
          'Geef je chauffeurs toegang tot hun persoonlijke dashboard met winsten, prestaties en bestelhistorie.',
      },
    },
    footer: {
  ...
  adminDriversPage: {
    ...
    failedToLoadData: 'Data niet geladen',
    search: 'Zoeken',
    searchPlaceholder: 'Zoek op naam, telefoonnummer, e-mail of ID',
    ...
    selectADriverText:
      'Klik op een chauffeur in de lijst links om zijn persoonlijke informatie en bestelhistorie te bekijken.',
    filters: 'Filters',
    employmentType: 'Werkloosheidstype',
    all: 'Alle',
    inactive: 'Inactief',
    salaried: 'Salaris',
    freelancer: 'Werkzaam',
